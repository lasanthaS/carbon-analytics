...
public class EventSyncConnectionPoolFactory extends BaseKeyedPoolableObjectFactory {
    ...
    public EventSyncConnectionPoolFactory(String host, int port) {
        this.hostname = host;
        this.port = port;
        eventSyncConnection = new EventSyncConnection();
    }

    @Override
    public Object makeObject(Object key) throws ConnectionUnavailableException {
        return eventSyncConnection.connect(hostname, port);
    }

    @Override
    public boolean validateObject(Object key, Object obj) {
        return obj != null && ((EventSyncConnection.Connection) obj).isActive();
    }

    public void destroyObject(Object key, Object obj) {
        if (obj != null) {
            ((EventSyncConnection.Connection) obj).shutdown();
        }
    }
}
